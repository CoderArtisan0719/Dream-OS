...
export default function DesktopStart() {
  return (
    <div className="my-2 mt-[76px] grid w-full auto-cols-[150px] grid-flow-row auto-rows-[180px] justify-center gap-2 overflow-auto md:justify-start md:gap-[17px] md:overflow-hidden">
